                    ...
                    <Grid item xs={12} sm={6} md={4} lg={3} key={index}>
                        <a href={`tel:${contact.number}`} style={{ textDecoration: 'none' }}>
                            ...
                            >
                                ...
                                <Typography variant="h6" align="center" color="textPrimary">{contact.name}</Typography>
                                <Typography variant="body1" align="center" color="textPrimary">{contact.number}</Typography>
                            </Box>
                        </a>
                    </Grid>
                ))}
