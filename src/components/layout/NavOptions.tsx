import { Dashboard, Announcement, Groups, Sell, Apartment, QuestionAnswer, Help } from '@mui/icons-material';
...
export const userOptions: NavOptions[] = [
    ...
    { text: 'Casos', icon: <QuestionAnswer />, link: '/app/cases', role: ['ADMIN'] },
