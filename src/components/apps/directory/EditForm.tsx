...
const EditFormDirectory = () => {
    ...
    useEffect(() => {
        const fetchDirectory = async () => {
            try {
                const response = await axios.get(`${DirectoryService.baseUrl}${DirectoryService.endpoints.GetById}/${id}`);
                setFormData(response.data);
                setSameAsPhone(response.data.phone === response.data.whatsAppNumber);
            } catch (error) {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            await axios.put(`${DirectoryService.baseUrl}${DirectoryService.endpoints.Update}/${formData._id}`, directoryData);
...
export default EditFormDirectory;